        ...
        <section className="flex flex-col gap-8">
          <div className="flex flex-col gap-4">
            ...
            <p className="text-[--color-ink-light] leading-relaxed">
              Joy Tech is where much of my time and energy is going right now. We're deep in building JOY Genesis, refining the hardware prototypes, and figuring out how to make a gaming ecosystem that actually works. It's hard, but that's kind of the point.
            </p>
          </div>
